function traerInformacion(){
    $.ajax({
        url: 'http://152.70.214.211/api/Message/all',
        type : 'GET',
        dataType : 'json',
...
function guardarInformacion(){
	...
	$.ajax(    
        'http://152.70.214.211/api/Message/save',
	{data: datosJson,
    type : 'POST',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
...
function editarRegistro (codMessage){
	$.ajax({    
    url : 'http://152.70.214.211/api/Message/'+codMessage,
	//data: "{}",
    type : 'GET',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
...
function actualizarInformacion(){
	...
	let datosJson = JSON.stringify(misDatos); 
	$.ajax(    
        'http://152.70.214.211/api/Message/update',
	{data: datosJson,
    type : 'PUT',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
...
function borrarRegistro(codMessage){
	...
	let datosJson = JSON.stringify(misDatos); 
	$.ajax(    
        'http://152.70.214.211/api/Message/'+codMessage,
	{data: datosJson,
    type : 'DELETE',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
