...
function traerInformacion(){
    $.ajax({
        url: 'http://152.70.214.211/api/Reservation/all',
        type : 'GET',
        dataType : 'json',
...
function guardarInformacion(){
	...
	$.ajax(    
        'http://152.70.214.211/api/Reservation/save',
	{data: datosJson,
    type : 'POST',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
...
function editarRegistro (id){
	$.ajax({    
    url : 'http://152.70.214.211/api/Reservation/'+id,
	//data: "{}",
    type : 'GET',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
...
function actualizarInformacion(){
	...
	let datosJson = JSON.stringify(misDatos); 
	$.ajax(    
        'http://152.70.214.211/api/Reservation/update',
	{data: datosJson,
    type : 'PUT',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
...
function borrarRegistro(id){
	...
	let datosJson = JSON.stringify(misDatos); 
	$.ajax(    
        'http://152.70.214.211/api/Reservation/'+id,
	{data: datosJson,
    type : 'DELETE',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
